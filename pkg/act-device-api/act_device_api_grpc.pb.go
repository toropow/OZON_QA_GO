...
type ActDeviceApiServiceClient interface {
	...
	// CreateDeviceRandomV2 - Create random device
	CreateDeviceRandomV1(ctx context.Context, in *CreateDeviceV1Request, opts ...grpc.CallOption) (*CreateDeviceV1Response, error)
...
func (c *actDeviceApiServiceClient) CreateDeviceV2(ctx context.Context, in *CreateDeviceV1Request, opts ...grpc.CallOption) (*CreateDeviceV1Response, error) {
	out := new(CreateDeviceV1Response)
	err := c.cc.Invoke(ctx, "/ozonmp.act_device_api.v1.ActDeviceApiService/CreateDeviceV1", in, out, opts...)
	if err != nil {
		return nil, err
...
func (c *actDeviceApiServiceClient) CreateDeviceRandomV1(ctx context.Context, in *CreateDeviceV1Request, opts ...grpc.CallOption) (*CreateDeviceV1Response, error) {
	out := new(CreateDeviceV1Response)
	err := c.cc.Invoke(ctx, "/ozonmp.act_device_api.v1.ActDeviceApiService/CreateDeviceRandomV1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActDeviceApiServiceServer interface {
	...
	// CreateDeviceRandomV2 - Create random device
	CreateDeviceRandomV1(context.Context, *CreateDeviceV1Request) (*CreateDeviceV1Response, error)
	// DescribeDeviceV1 - Describe a device
...
func (UnimplementedActDeviceApiServiceServer) CreateDeviceRandomV1(context.Context, *CreateDeviceV1Request) (*CreateDeviceV1Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDeviceRandomV1 not implemented")
}
...
func _ActDeviceApiService_CreateDeviceRandomV1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDeviceV1Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActDeviceApiServiceServer).CreateDeviceRandomV1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozonmp.act_device_api.v1.ActDeviceApiService/CreateDeviceRandomV1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActDeviceApiServiceServer).CreateDeviceRandomV1(ctx, req.(*CreateDeviceV1Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ActDeviceApiService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateDeviceRandomV1",
			Handler:    _ActDeviceApiService_CreateDeviceRandomV1_Handler,
		},
		{
