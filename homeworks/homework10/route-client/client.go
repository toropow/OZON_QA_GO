...
type Client interface {
	...
	CreateDevice(ctx context.Context, body DeviceRequest) (CreateDeviceResponse, *http.Response, error)
	...
	UpdateDevice(ctx context.Context, deviceId string, body DeviceRequest) (UpdateDeviceResponse, *http.Response, error)
}
...
func (c *client) CreateDevice(ctx context.Context, body DeviceRequest) (CreateDeviceResponse, *http.Response, error) {
	var (
...
func (c *client) UpdateDevice(ctx context.Context, deviceId string, body DeviceRequest) (UpdateDeviceResponse, *http.Response, error) {
	var (
